...
public class SideConfigurator<T> implements INBTSerializable<CompoundNBT> {
    ...
    public String getTranslationKey() {
        return "rms.gui.sideConfigurator.title." + id;
    }
    ...
    void setupFacingMatrix() {
        for (Direction f : RMSUtils.HORIZONTALS) {
    ...
    public ITextComponent getFaceLabel(RelativeFace relativeFace) {
        ...
        return c == null ?
                xlate("rms.gui.sideConfigurator.unconnected") :
                xlate("rms.gui.sideConfigurator." + id + "." + c.id);
    }
